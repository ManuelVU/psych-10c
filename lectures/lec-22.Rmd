...
--
  ...
  $$y_i \sim \text{Normal}(\beta_0 + \beta_3 \text{sex}_i,\sigma_5^2)$$
...
--
  ...
  $$y_i \sim \text{Normal}(\beta_0 + \beta_1\text{age}_i + \beta_3 \text{sex}_i,\sigma_6^2)$$
...
--
  ...
  $$y_i \sim \text{Normal}(\beta_0 + \beta_2\text{height}_i + \beta_3 \text{sex}_i,\sigma_7^2)$$
...
--
  ...
  $$y_i \sim \text{Normal}(\beta_0 + \beta_1\text{age}_i + \beta_2\text{height}_i + \beta_3 \text{sex}_i,\sigma_8^2)$$
...
that only consiedred height as a predictor. $(\hat{\beta}_2 =$ `r round(betas_hs[2],2)`)
