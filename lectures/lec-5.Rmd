...
- The difference between our parameters, $\mu_1$ and $\mu_2$ can be interpreted
as the effect on our random variable of been in group 1 in comparison to group 2.

--

- In our smoking example, the difference between $\mu_1$ and $\mu_2$ can be 
interpreted as the effect of smoking on lung capacity.
...
$$\hat{\mu_1} = \frac{1}{n} \sum_i y_{i1}$$ 

--

$$\hat{\mu_2} = \frac{1}{n} \sum_i y_{i2}$$
...
observations of each group respectively.
...
our observations from what our predictions $\hat{\mu}_j$ for the group.
