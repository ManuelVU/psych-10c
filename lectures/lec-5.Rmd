...
can be tracked directly to the Expectation and Variance of the random variable.

--

- In other words, the Null model assumes that our observations are random 
variables that follow a Normal distribution with parameters $\mu$ and $\sigma^2$.
...
distributions, one centered at $\mu_1$ and the other one centered at $\mu_2$.
...
In other words, the effect on our random variable that comes from being a member 
of either group 1 or group 2.
