...
form two cohorts 2019 and 2020, and we record whether they are took a statistics 
...
- As with the rest of the models in the class, the key part of the model will 
be the predictions that it makes and how we can derive those predictions.
...
--
  ...
  4. Using the SSE we can compute the Mean Squared Error (mse), the proportion
...
- We will need to make some changes to how we express our models, however, this
will not change how we arrive to the predictions of our models (we will still
use averages).
...
design will be easier to follow. Given that the steps we will take are the same
as with previous problems.
