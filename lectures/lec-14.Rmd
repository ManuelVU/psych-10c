...
- The predictions of the Main effects models were equal to the sum of the 
...
$$\hat{\alpha}_1 = \hat{\mu}_{1\cdot} - \hat{\mu}$$ and $$\hat{\beta}_1 = \hat{\mu}_{\cdot 1} - \hat{\mu}$$
...
- Finally, we mention that the predictions of the full model were equal to the 
...
took a statistics class during their first year have an effect on the anxiety 
levels they experience at the end of their first year.

--

- In order to study whether our factors (cohort and having taken the statistics
class) have an effect on the anxiety levels of students we asked them to 
respond to an anxiety scale.

--

- Then we record whether they started college in 2019 or if they started in 
2020 and whether they took a statistics class during their first year or not.

--

- We collected information from a total of 16 participants for this study, 4 of 
which started college in 2019 and took a statistics class in their first year, 
4 started college in 2019 and didn't take a statistics class, 4 started college 
in 2020 and took a statistics class and the remaining 4 started in 2020 and 
didn't take a statistics class during the first year.
...
difference between the average of the group and the grand mean.
...
- Which of the models can better account for our data?
  ...
  - The model that better accounted for our data according to the BIC, was the 
  additive model.
...
(effect of cohort and class) 
  ...
  - This indicates that both the cohort that a student belongs to and whether 
  they took a statistics class during the year have an effect on the anxiety 
  levels of students.
...
- How can we interpret the estimates of the model?
  ...
  - According to our data, the average anxiety level of students was $11.9$ 
  points. The expected anxiety levels of students in the 2020 cohort was $1.77$
  points higher on average than the mean. On the other hand, the expected 
  anxiety levels of students that took a statistics class was $1.5$ points 
  higher on average.
...
interpret it:
  ...
  - The $R^2$ of the additive model was $0.9$, which means that it can account 
  for 90% of the variability in the data.
