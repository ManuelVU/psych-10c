...
correctly recalled came from the first or second test, we could use the current 
variables to add a new variable that contains this information
...
# of the presceding line and uses it as input on the next one
memory <- memory %>% 
...
- We will use our new variable to create plots our data.
