...
observation number $i$, and the group $j$ (smoking status), every observation is
...
- Notice that we don't specify the values of $\mu$ and $\sigma^2$ that define our
statistical model. Hhowever, we can still graph what the Null Model expects the 
data to look like.
