...
- Reminder: We want to know if people who smoke have lower lung capacity 
...
capacity is a function of smoking status, in other words, that the **groups 
are different**.
...
observation number $i$, and the group $j$ (smoking status), participant are all 
