...
knitr::opts_chunk$set(fig.width = 6, message = FALSE, 
                      ...
                      cache = F)
test <- rbinom(n = 60, size = 1, prob = rep(c(0.25,0.1),each=30))
...
- We take a sample of 30 participants from two different populations, one that 
...
|--------------------|:-----------:|:--------------:|:-------------:|
| Not vaccinated     | 30          | `r cov_prop$positive_test[1]` | `r round(cov_prop$positive_test[1]/30,2)` |
| Vaccinated         | 30          | `r cov_prop$positive_test[2]` | `r round(cov_prop$positive_test[2]/30,2)` |
