...
12. Write Model 1 (**no improvement**) in mathematical notation.

**ANS:** [WRITE YOUR ANSWER HERE]

13. Make a density graph for Model 1 (**no improvement**). To make the plot, 
...
14. What are the predictions made by Model 1 (**no improvement**)? Again, make sure to test them by adding the corresponding variable (column) to our data base.
...
15. Calculate the squared error (SE) of each observation for Model 1 and
...
17. Write Model 2 (**improvement**) in mathematical notation.

**ANS:** [WRITE YOUR ANSWER HERE]

18. Make a density graph for Model 2 (**improvement**). Remember that at 
