...
# Code 1: Load the data (Hint: Go back to Lec-1 (or homework-1!))
#
...
Once again, we have two competing models (hypotheses) about the performance of participants on the maze before and after training. Model 1 (**no improvement**)
...
# Code 10: Load the data (Hint: Go back to Lec-1 (or homework-1!))
#
...
15. What are the predictions made by Model 1 (**no improvement**)? Again, make sure to test them by adding the corresponding variable (column) to our data base.
