...
**Background:** This first data set comes from an experiment designed to test whether 
drinking coffee makes people smarter. Participants were divided into two groups.
All participants took an IQ test, but participants in **group 1** drank water 5 
minutes before the test, while participants in **group 2** drank coffee.

```{r load_data, echo = TRUE}
# In this section you should write (a.k.a. copy from the slides) the code needed 
...
3. Which group had more variation in their test scores on the *IQ* test, those 
...
4. Create two histograms for the *IQ* test results that each group got (1 per group). In other words, 
one of these histograms must show the IQ scores for participants who weren’t given coffee before the IQ test, 
and the other histogram should show how participants who were given coffee performed. Describe 
...
**Background:** This second data set comes from an experiment designed to test whether a new form of training 
...
training. Participants in both conditions were then instructed to complete a maze as quickly as 
possible. The data provides information about how quickly each participant completed the maze, in seconds.
...
# code chunks. Remember to delete the comments inside the code chunks BEFORE 
