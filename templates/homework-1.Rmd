...
```{r prep_tinytex, include=FALSE}
# Run this code chunk to install the package you'll need to output this homework as a PDF
# (which you can then submit)
...
1. What is the average score on the *IQ* test for participants who drink coffee?
...
1. Which group had more variation in their test scores on the *IQ* test, those 
